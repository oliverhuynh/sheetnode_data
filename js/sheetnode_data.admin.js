...
Drupal.behaviors.sheetnode_data_admin = {
  attach: function(context) {
    var js_obj = jQuery('input[name="sheetnode_data_unload_js"]', context);
    var js_message_obj = jQuery('input[name="sheetnode_data_unload_js_message"]', context);
    var js_message_form_item_obj = js_message_obj.parents('.form-item');
    var js_message_enable_obj = jQuery('input[name="sheetnode_data_unload_js_message_enable"]', context);
